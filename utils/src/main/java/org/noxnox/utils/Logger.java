...
public final class Logger {
    private static final String DEFAULT_TAG = "noxnox.org";
    ...
    public void i(final String format, final Object... args) {
        if (isLoggable(Log.INFO)) {
            ...
            if (this.enableNetworkLog) {
                this.doNetworkLog("info", toMessage(format, args));
            }
        }
    }
    ...
    private void doNetworkLog(String level, String payload) {
        ...
        AndroidNetworking.post(Logger.LOG_SERVER + "/alog").setPriority(Priority.LOW).setTag("log").addJSONObjectBody(jsonObject).build().getAsString(new StringRequestListener() {
            @Override
    ...
    public boolean isEnableNetworkLog() {
        return enableNetworkLog;
    }

    public void setEnableNetworkLog(boolean enableNetworkLog) {
        this.enableNetworkLog = enableNetworkLog;
    }

    private boolean enableNetworkLog = false;
